          ...
          <div class="hero-body has-text-centered slide-body has-text-black">
            ...
            <g id="name">
              ...
              <g id="triangle-lines">
                ...
                <path class="yellow" d="M683.85,596.09l.68-.51q16.29-12.3,32.59-24.59l60.68-45.85-1-11.08-103.33,78Z"/>
                <path class="yellow"
              ...
              <g id="triangles">
                <polygon class="pure-white dark-grey-stroke large-stroke" points="183.62 40.31 319.75 592.34 638.95 316.33 183.62 40.31"/>
                <polygon class="yellow dark-grey-stroke large-stroke" points="151.23 42.45 287.36 594.48 606.56 318.46 151.23 42.45"/>
              </g>
              <g id="Sam" class="logo-name-text">
                <text class="dark-grey large-stroke" transform="matrix(0.98, -0.19, 0.19, 0.98, 176.84, 317.86)">Sam</text>
              ...
              <g id="subtitle">
                <text class="logo-subtitle-text" transform="translate(276.34 459.95) rotate(-10.96)">ui designer &amp;</text>
                <text class="logo-subtitle-text" transform="translate(280.08 479.26) rotate(-10.96)">frontend engineer</text>
              </g>
            </g>
            </svg>
          </div>
