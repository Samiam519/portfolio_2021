<template>
  <div id="changer-wrapper" class="is-absolute">
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150.66 150.66">
      ...
      <circle class="yellow" cx="76.52" cy="63.57" r="23.14"/>
      <path class="yellow"
      ...
      <path class="black-stroke" d="M144.38,104.59a34.34,34.34,0,0,1-43.31,22" @click="next"/>
      <path class="black-stroke" d="M8.11,51.94A34.33,34.33,0,0,1,25.33,6.53" @click="prev"/>
    </svg>
  </div>
</template>
